Ceci est une application web utilisant Angular pour le frontend, Spring Boot pour le backend, et MySQL (via phpMyAdmin) pour la gestion de la base de données.
